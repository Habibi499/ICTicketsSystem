...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h5 class="m-0"><i class="fa fa-tasks" aria-hidden="true"></i>&ensp;&ensp;All my Assigned Tickets</h5>
      </div>
      <!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="{{route('ticket.index')}}">Home</a></li>
          <li class="breadcrumb-item"><a href="{{route('requestedtickets.index')}}">All Tickets</a></li>
          <li class="breadcrumb-item">My Assigned Tickets</li>
        </ol>
      </div>
      <!-- /.col -->
    </div>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box">
            <span class="info-box-icon bg-info elevation-1">{{$Totalticketscount}}</span>
              ...
              <div class="col-md-12">
                ...
                <div class="card-header">
                  <div class="card-title">
                    <i class="fa fa-tasks" aria-hidden="true"></i>&ensp;&ensp;All my Tickets that have been Assigned
                  </div>
