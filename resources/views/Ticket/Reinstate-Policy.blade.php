...
<div class="content-header">
    <div class="container-fluid">
       <div class="row mb-2">
          <div class="col-sm-6">
             <i class="fas fa-ban"></i>&ensp;&ensp;Policy ReInstatement
          </div>  <!-- /.col -->
          <div class="col-sm-6">
             <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('ticket.index')}}">Home</a></li>
                <li class="breadcrumb-item">Policy ReInstatement</li>
             </ol>
          </div>  <!-- /.col -->
       </div> <!-- /.row -->
    </div>   <!-- /.container-fluid -->
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="form_wrap"> 
                <h2>Policy ReInstatement Request form &ensp;<i class="fa fa-plus-circle text-warning"></i></h2>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="input_wrap">
                                ...
                                <input type="text" name="TicketCategory" value="Policy Reinstatement" hidden>
                                <input type="text" name="Correction_Type" value="Policy Reinstatement" hidden>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input_wrap">
                                ...
                                <textarea rows="3" class="form-control" name="Correction_Details" id="textarea">
                                    Please Reinstate the Policy above as per the details provided here
