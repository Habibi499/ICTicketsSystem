...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h5 class="m-0"><i class="fa fa-1x fa-times" aria-hidden="true"></i>&ensp;&ensp;My UnApproved tickets</h5>
      </div>
      <!-- /.col -->
      <div class="col-sm-6">
              ...
              <div class="col-md-12">
                ...
                <div class="card-header">
                  <div class="card-title">
                    <i class="fa  fa-times" aria-hidden="true"></i>&ensp;&ensp;My UnApproved Tickets
                  </div>
