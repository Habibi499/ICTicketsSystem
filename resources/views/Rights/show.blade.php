                              ...
                              <div class="form-row topform" style="border-top:1px solid rgb(203,203,203);">
                                ...
                                <div class="form-row topform" style="border-top:1px solid rgb(203,203,203);">
                                  <div class="col-md-12 ">
                                      ...
                                      <input type="text" name="Correction_Type" class="form-control1" id="CorrectionType"  value="{{$tickets->first()->HodApprovalStatus}}" readonly>           
                                  </div>
                                </div>
                            </div>
                          </div><!--Requester---->
                      ...
                      <div class="col-md-2" id="RightTicketPanel" >
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="" value="" style="font-size:14px;"  readonly>
                          </div>
                        </div>   
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="" value="{{$tickets->first()->TicketStatus}}" style="font-size:14px;" readonly>
                          </div>
                        </div>   
